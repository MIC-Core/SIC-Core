...
These simulation tasks are initiated by simulation requests, use simulation models and other resources, and produce results that support engineering decisions (see figure 1).
...
While the MIC Core specification provides metadata for simulation models, it does not support and describe the simulation tasks in which those models are used.
